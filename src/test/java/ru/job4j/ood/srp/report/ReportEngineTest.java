...
public class ReportEngineTest {
    ...
    public void whenXmlReportGenerated() throws JAXBException {
        ...
        store.add(worker2);
        store.add(worker3);
        Report engine = new XmlReportEngine(
                store, JAXBContext.newInstance(Employee.Employees.class));
        StringBuilder expect = new StringBuilder();
        expect.append("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>")
                .append("<employees>")
                    .append("<employees>")
                        .append("<fired>").append(parser.parse(worker.getFired()))
                        .append("</fired>")
                        .append("<hired>").append(parser.parse(worker.getFired()))
                        .append("</hired>")
                    ...
                    .append("<employees>")
                        ...
                        .append("</fired>")
                        .append("<hired>").append(parser.parse(worker2.getFired()))
                        .append("</hired>")
    ...
    public void whenJsonReportGenerated() {
        ...
        expect.append("[{")
                ...
                .append("\"dayOfMonth\":").append(worker4.getHired().get(Calendar.DAY_OF_MONTH))
                .append(",")
                .append("\"hourOfDay\":").append(worker4.getHired().get(Calendar.HOUR_OF_DAY))
                .append(",")
                ...
                .append("\"dayOfMonth\":").append(worker4.getFired().get(Calendar.DAY_OF_MONTH))
                .append(",")
                .append("\"hourOfDay\":").append(worker4.getFired().get(Calendar.HOUR_OF_DAY))
                .append(",")
                ...
                .append("\"dayOfMonth\":").append(worker5.getHired().get(Calendar.DAY_OF_MONTH))
                .append(",")
                .append("\"hourOfDay\":").append(worker5.getHired().get(Calendar.HOUR_OF_DAY))
                .append(",")
                ...
                .append("\"dayOfMonth\":").append(worker5.getFired().get(Calendar.DAY_OF_MONTH))
                .append(",")
                .append("\"hourOfDay\":").append(worker5.getFired().get(Calendar.HOUR_OF_DAY))
                .append(",")
