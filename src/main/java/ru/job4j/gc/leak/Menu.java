 ...
 * реализацию удаления каждого поста по id пропустили. Удаляем все сразу.
 */
public class Menu {
    ...
    public static final String TEXT_OF_ALL_POST_DELETE = "Все посты удалены";
    ...
    private static void start(CommentGenerator commentGenerator,
        ...
        while (run) {
            ...
            if (ADD_POST == userChoice) {
                ...
                System.out.println(TEXT_OF_ALL_POST_DELETE);
                postStore.removeAll();
            } else {
                run = false;
