...
/**
 * Генератор комментариев. Также при создании заполним список фразами, а при вызове
 * generate зачистим список, а затем сгенерируем 50 комментариев из случайных фраз.
 */
